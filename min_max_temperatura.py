...
def teste_pontual(temp, valor_esperado):
    ...
    if minima(temp) != valor_esperado:
        ...
        print(
            f"Valor esperado: {valor_esperado}. Valor calculado: {valor_calculado}")
...
def testa_minima():
    ...
    teste_pontual([30, 27, 25, 26, 29, 31, 32, 33, 30, 29, 24, 26, 30, 27, 24,
                   25, 26, 24, 22, 23, 25, 25, 28, 28, 32, 32, 31, 29, 28, 31, 33], 22)
    teste_pontual([-15, -12, 0, 20, 30], -15)
    print("Finalizando os testes")


MinMax([30, 27, 25, 26, 29, 31, 32, 33, 30, 29, 24, 26, 30, 27, 24,
        25, 26, 24, 22, 23, 25, 25, 28, 28, 32, 32, 31, 29, 28, 31, 33])
